    ...
    onMount(() => {
        if (canvasRef instanceof HTMLCanvasElement) {
            ...
            cancelLoop = createLoop((time) => {
                ...
                createCircle(ctx, (200 + time / 3) % width, 100 + Math.cos(nTime / 100) * 10, 5);
                createCircle(ctx, (200 + time / 4) % width, 200 + Math.cos(nTime / 100) * 10, 5);
                createCircle(ctx, (200 + time / 5) % width, 300 + Math.cos(nTime / 100) * 10, 5);
            });
        }
    });
